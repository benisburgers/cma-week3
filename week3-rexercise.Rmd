...
```{r, warning=FALSE}
DTW <- c()
DTW[1] <- DTW(pedastrian1_matrix, pedastrian2_matrix, pointSpacing = 4)
DTW[2] <- DTW(pedastrian1_matrix, pedastrian3_matrix, pointSpacing = 4)
DTW[3] <- DTW(pedastrian1_matrix, pedastrian4_matrix, pointSpacing = 4)
DTW[4] <- DTW(pedastrian1_matrix, pedastrian5_matrix, pointSpacing = 4)
DTW[5] <- DTW(pedastrian1_matrix, pedastrian6_matrix, pointSpacing = 4)
DTW

EditDist <- c()
EditDist[1] <- EditDist(pedastrian1_matrix, pedastrian2_matrix, pointDistance = 4)
EditDist[2] <- EditDist(pedastrian1_matrix, pedastrian3_matrix, pointDistance = 4)
EditDist[3] <- EditDist(pedastrian1_matrix, pedastrian4_matrix, pointDistance = 4)
EditDist[4] <- EditDist(pedastrian1_matrix, pedastrian5_matrix, pointDistance = 4)
EditDist[5] <- EditDist(pedastrian1_matrix, pedastrian6_matrix, pointDistance = 4)
EditDist

Frechet <- c()
Frechet[1] <- Frechet(pedastrian1_matrix, pedastrian2_matrix, testLeash = -1)
Frechet[2] <- Frechet(pedastrian1_matrix, pedastrian3_matrix, testLeash = -1)
Frechet[3] <- Frechet(pedastrian1_matrix, pedastrian4_matrix, testLeash = -1)
Frechet[4] <- Frechet(pedastrian1_matrix, pedastrian5_matrix, testLeash = -1)
Frechet[5] <- Frechet(pedastrian1_matrix, pedastrian6_matrix, testLeash = -1)
Frechet
...
results <- tibble(DTW, EditDist, Frechet, LCSS, path = as.factor(c(2, 3, 4, 5, 6)))
results
...
Why do my plots look so much different than the ones provided by the examples?
