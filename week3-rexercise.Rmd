...
# Calculating the trajectory similarities for each 1:n pair and with every method
...
# Putting those results together in order to visualize them easier (wasn't easier)

results <- tibble(DTW, EditDist, Frechet, path = c(2, 3, 4, 5, 6))
results
